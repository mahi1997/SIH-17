  ...
  success: function(data){
   $("#schoollist").html(data);
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control" name="school" id="schoollist" >
        ...
        <div class="col-md-3" style="padding-top:80px;">
          <div class="panel panel-danger">
            <div class="panel-heading">
              <h3 class="panel-title"><span class="glyphicon glyphicon-pencil"></span>  Update</h3>
            </div>
            <div class="panel-body bg-warning">
              <ul class="list-group text-success">
                ...
                <a href="add_announcements.php"><li class="list-group-item">Update Announcements<span class="glyphicon glyphicon-plus-sign" style="float:right;"></span></li></a>
                <a href="cms.php"><li class="list-group-item">Site Manager<span class="glyphicon glyphicon-plus-sign" style="float:right;"></span></li></a>
