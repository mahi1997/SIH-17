  ...
  <head>
    ...
    <style>
      ...
      *{
      ...
      div.image:before{
        <?php 
        $getid = "SELECT `id`  FROM `school_list`  WHERE  `School ID`=".$schoolid;
              $result = mysqli_query($dbcon,$getid);
              $row = mysqli_fetch_row($result);
        $url="content:url(http://localhost/sihcoding/display_image.php?id=".$row[0].");";
        echo $url;
         ?>
...
<body>
  ...
  <div class="row" style="margin-top:8px;">
    ...
    <!--
    <img class="img-responsive" src="public/images/kv.jpg">
      ...
      <div class="panel panel-danger">
        ...
        <div class="panel-body bg-warning">
          <ul class="list-group text-success">
                  ...
                  <?php
                  $tablecontact="contact_".$schoolid;
                  $getContact = "SELECT `Name`,`Position`,`Mobile` FROM  ".$tablecontact."  WHERE  1" ;
              ...
              <li class="list-group-item"> <?php echo $row['Name'].", ".$row['Position'].", ".$row['Mobile'] ; ?></li>
    ...
    <table class="table table-bordered table-hover" style="background-color:white;margin-top:5px;">
      ...
      <tbody>
               ...
               ///receive meeting data from database
                  ...
                  $getContent = "SELECT * FROM  ".$tablemeeting."   ORDER BY `id` DESC" ;
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-hover" style="background-color:white;margin-top:5px;">
      ...
      <tbody>
               ...
               <?php
               ///receive meeting data from database
                  $tabletask="task_".$schoolid;
                  $getContent = "SELECT * FROM  ".$tabletask."   ORDER BY `id` DESC" ;
              $result = mysqli_query($dbcon,$getContent);
               $i=1;
               while($row = mysqli_fetch_array($result))
              {
    ...
    <table class="table table-bordered table-hover" style="background-color:white;margin-top:5px;">
      ...
      <tbody>
        <tr>
         ...
         <?php
               ///receive meeting data from database
                  $tablefund="fund_".$schoolid;
                  $getContent = "SELECT * FROM  ".$tablefund."   ORDER BY `id` DESC" ;
              $result = mysqli_query($dbcon,$getContent);
               $i=1;
               while($row = mysqli_fetch_array($result))
              {
